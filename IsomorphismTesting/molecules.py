...
class MoleculeDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset, name):
        ...
        print('all data sizes :',len(self.data_all))
    ...
    def collate(self, samples):
        ...
        data, g_dgl = map(list, zip(*samples))
        #data = torch.tensor(np.array(data)).unsqueeze(1)
        batched_graph = dgl.batch(g_dgl)            
        
        return data , batched_graph 
